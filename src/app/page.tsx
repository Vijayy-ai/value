...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#001122] via-[#002244] to-[#003366]">
      ...
      <section className="py-20 bg-gradient-to-br from-white via-gray-50 to-cyan-50 relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          <motion.div
            ...
            className="absolute top-10 left-10 w-80 h-80 border-2 border-cyan-400 rounded-full"
          />
          <motion.div
            animate={{ 
              scale: [1.2, 1, 1.2], 
            ...
            className="absolute bottom-10 right-10 w-60 h-60 border-2 border-cyan-300 rounded-full"
          />
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          >
            <motion.div
              ...
              viewport={{ once: true }}
              className="inline-block bg-cyan-500/20 backdrop-blur-sm border border-cyan-500/30 rounded-full px-8 py-3 mb-8"
            >
              <span className="text-cyan-700 font-bold text-sm uppercase tracking-wide">About Our Company</span>
            </motion.div>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="mt-8 bg-cyan-600 border-2 border-cyan-600 text-white px-10 py-4 rounded-full font-bold text-lg hover:bg-cyan-700 hover:border-cyan-700 transition-all duration-300 shadow-2xl"
            >
              Learn More About Us →
            </motion.button>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                className="text-center bg-white/90 backdrop-blur-sm p-8 rounded-2xl border border-cyan-400/30 relative overflow-hidden group shadow-xl"
              >
                ...
                <motion.div
                  ...
                  className="text-4xl md:text-5xl font-bold text-cyan-600 mb-3 relative"
                >
                  {stat.number}
                </motion.div>
                <div className="text-lg md:text-xl text-gray-800 font-bold relative mb-1">{stat.label}</div>
      ...
      <section className="py-20 bg-gradient-to-br from-[#0066aa] via-[#004477] to-[#002445] relative overflow-hidden">
        {/* Background Pattern */}
        <div className="absolute inset-0 opacity-10">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_25%_25%,_#06b6d4_2px,_transparent_2px)] bg-[length:60px_60px]" />
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          >
            <motion.div
              ...
              transition={{ duration: 0.6, delay: 0.2 }}
              viewport={{ once: true }}
              className="inline-block bg-cyan-400/10 backdrop-blur-sm border border-cyan-400/20 rounded-full px-8 py-3 mb-8"
            >
              <span className="text-cyan-300 font-bold text-sm uppercase tracking-wide">Why Choose Us</span>
            </motion.div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <div className="relative bg-gradient-to-br from-cyan-100 to-blue-100 backdrop-blur-sm rounded-3xl overflow-hidden h-[500px] shadow-2xl border border-cyan-300">
                <motion.div
                  animate={{ scale: [1, 1.05, 1] }}
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <h3 className="text-3xl font-bold text-gray-800 mb-4">Our Amazing Team</h3>
                    <p className="text-gray-600 text-lg">Passionate professionals driving success</p>
                  </div>
                </div>
                ...
                <div className="absolute bottom-6 left-6 flex space-x-3">
                  {[
                    ...
                    <motion.div
                      ...
                      className={`w-14 h-14 ${member.color} rounded-full flex items-center justify-center text-white font-bold text-lg shadow-lg cursor-pointer`}
                    >
                      {member.name[0]}
                    </motion.div>
                  ))}
                ...
                <motion.div
                  ...
                  className="absolute top-6 right-6 w-16 h-16 border-4 border-cyan-400/50 rounded-full"
                />
              </div>
            </motion.div>
            ...
            >
              <motion.div
                ...
                className="inline-block bg-cyan-500/20 backdrop-blur-sm border border-cyan-500/30 rounded-full px-8 py-3 mb-8"
              >
                <span className="text-cyan-700 font-bold text-sm uppercase tracking-wide">Our Team</span>
              </motion.div>
              ...
              <div className="space-y-4 mb-8">
                {[
                  ...
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    className={`flex items-center space-x-4 p-4 ${point.color} backdrop-blur-sm rounded-xl hover:shadow-lg transition-all duration-300 border`}
                  >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="bg-cyan-600 border-2 border-cyan-600 text-white px-12 py-5 rounded-full font-bold text-xl hover:bg-cyan-700 hover:border-cyan-700 transition-all duration-300 shadow-2xl"
              >
                Meet Our Team →
              </motion.button>
            </motion.div>
      ...
      {/* Global Reach CTA */}
      <section className="py-20 bg-gradient-to-br from-[#001122] via-[#002445] to-[#003366] text-white relative overflow-hidden">
        {/* Background elements */}
        <div className="absolute inset-0">
          <motion.div
            animate={{
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center px-6">
          ...
          >
            <motion.div
              ...
              transition={{ duration: 0.6, delay: 0.2 }}
              viewport={{ once: true }}
              className="inline-block bg-cyan-400/10 backdrop-blur-sm border border-cyan-400/20 rounded-full px-6 py-2 mb-8"
            >
              <span className="text-cyan-400 font-semibold text-sm uppercase tracking-wide">Let&apos;s Connect</span>
            </motion.div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="bg-cyan-400 text-gray-900 px-10 py-4 rounded-full font-bold text-lg shadow-2xl transition-all duration-300"
              >
                Get Started Today
              </motion.button>
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="border-2 border-cyan-400 text-cyan-400 px-10 py-4 rounded-full font-bold text-lg hover:bg-cyan-400 hover:text-gray-900 transition-all duration-300"
              >
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              {[
                ...
                >
                  ...
                  <div className="text-cyan-400 font-medium">{item.value}</div>
                </motion.div>
              ))}
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="absolute inset-0">
              <motion.div
                ...
                className="absolute top-0 right-0 w-80 h-80 bg-cyan-400/20 rounded-full -mr-40 -mt-40"
              />
              <motion.div
                animate={{ 
                  scale: [1.2, 1, 1.2],
                ...
                transition={{ duration: 20, repeat: Infinity }}
                className="absolute bottom-0 left-0 w-64 h-64 bg-purple-400/20 rounded-full -ml-32 -mb-32"
              />
                ...
                <div className="lg:col-span-2">
                  ...
                  >
                    <div className="inline-block bg-cyan-500/20 border border-cyan-500/30 rounded-full px-6 py-2 mb-6">
                      <span className="text-cyan-700 font-semibold text-sm uppercase tracking-wide">Newsletter</span>
                    </div>
